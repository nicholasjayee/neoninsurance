        ...
        {link.href ? (
          <>
            <Link
              ...
              onClick={closeMenu}
              className={clsx(
                "grow text-lg font-semibold rounded-md p-3 transition-colors",
                isActive
                  ? "bg-brand-primary/10 text-brand-primary"
                  : "text-brand-text-secondary hover:bg-gray-100"
              )}
          ...
          <button
            onClick={() => setIsAccordionOpen(!isAccordionOpen)}
            className="w-full flex items-center justify-between text-lg font-semibold rounded-md p-3 transition-colors text-brand-text-secondary hover:bg-gray-100"
          >
              ...
              {link.href && (
                <li className="mb-3 px-4">
                  <Link
                    href={link.href}
                    onClick={closeMenu}
                    className="inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-brand-primary to-brand-primary-light text-white rounded-lg font-semibold text-sm hover:shadow-lg transition-all"
                  >
        ...
        <AnimatePresence>
          {isOpen && (
            <>
              ...
              >
                {/* --- 1. FIXED HEADER --- */}
                <div className="shrink-0 flex items-center justify-between p-6 border-b border-brand-border">
                  <Link
                    href="/"
                    onClick={() => setIsOpen(false)}
                ...
                {/* --- 3. FIXED FOOTER / CTA --- */}
                <div className="shrink-0 p-6 border-t border-brand-border">
                  <motion.div
